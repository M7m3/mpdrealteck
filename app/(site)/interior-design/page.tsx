...
import InteriorDesign from '@/components/sections/interiorDesign/InteriorDesign'

export const metadata = {
  title: 'Interior Design Services',
  description:
    "MPD Realteck's interior design team delivers space planning and fit-outs for homes and offices, from concept to handover, across India.",
  alternates: { canonical: '/interior-design' },
}

const TRUST_STRIP = ['40+ Years of Legacy', 'In-House Design Team', 'Turnkey Execution']
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="relative mt-0 w-full min-h-[70vh] overflow-hidden bg-slate-900 md:mt-16">
        <Image
          src="https://images.unsplash.com/photo-1611048267451-e6ed903d4a38"
          alt="Beautifully designed modern living room interior by MPD Realteck"
          fill
          priority
          sizes="100vw"
          ...
          <div className="mx-auto w-full max-w-7xl">
            <div className="max-w-2xl">
              ...
              <h1 className="mt-6 text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl leading-[1.08]">
                ...
                <br />
                <span className="text-blue-400">how you live and work.</span>
              </h1>

              <p className="mt-6 max-w-xl text-base leading-relaxed text-slate-300 lg:text-lg">
                Space planning and interior fit-outs for residential and corporate clients, delivered alongside your construction timeline or as a standalone project.
              </p>

              <div className="mt-10 flex flex-wrap items-center gap-4">
                <Link href="#interior-design-inquiry">
                ...
                <Link href="#interior-design-gallery">
