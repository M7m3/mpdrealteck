...
import CorporateRealEstate from '@/components/sections/corporateRealEstate/CorporateRealEstate'

export const metadata = {
  title: 'Corporate Real Estate Services in India',
  description:
    "MPD Realteck's corporate real estate desk manages workplace strategy, relocation, and facility planning for growing businesses across India.",
  alternates: { canonical: '/corporate-real-estate' },
}

const TRUST_STRIP = ['40+ Years of Legacy', 'Dedicated Corporate Desk', 'UP-RERA Compliant']
    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="relative mt-0 w-full min-h-[70vh] overflow-hidden bg-slate-900 md:mt-16">
        <Image
          ...
          alt="Modern corporate office workspace managed through MPD Realteck's corporate real estate services"
          fill
          priority
          sizes="100vw"
          ...
          <div className="mx-auto w-full max-w-7xl">
            <div className="max-w-2xl">
              ...
              <p className="mt-6 max-w-xl text-base leading-relaxed text-slate-300 lg:text-lg">
                Workplace strategy, relocation, and facility planning for businesses that need more than a lease agreement.
              </p>

              <div className="mt-10 flex flex-wrap items-center gap-4">
                <Link href="#corporate-real-estate-inquiry">
