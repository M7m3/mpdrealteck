...
export const metadata = {
  title: 'Real Estate Consulting & Advisory Services',
  description:
    "Get expert investment strategy, acquisition planning, and corporate real estate advisory from MPD Realteck's consulting desk, serving clients across India.",
      ...
      <div className="relative bg-slate-900 py-20 text-center overflow-hidden border-b border-slate-800">
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm md:text-base text-slate-400 leading-relaxed">
            Investment strategy, acquisition planning, and corporate real estate advisory for buyers, developers, and businesses across India.
          </p>
        </div>
      </div>
