...
import DueDiligence from '@/components/sections/dueDiligence/DueDiligence'

export const metadata = {
  title: 'Property Due Diligence & Title Verification',
  description:
    "MPD Realteck's due diligence desk verifies title, encumbrances, RERA compliance, and litigation history before you buy property anywhere in India.",
      ...
      <div className="relative bg-slate-900 py-20 text-center overflow-hidden border-b border-slate-800">
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-white sm:text-5xl leading-[1.1]">
            Property Due Diligence & Title Investigation
          </h1>
          <p className="mx-auto mt-4 max-w-xl text-sm md:text-base text-slate-400 leading-relaxed">
            Before you commit capital anywhere in India, our due diligence desk verifies title, encumbrances, RERA compliance, and litigation history, so you buy with certainty.
          </p>
        </div>
      </div>
