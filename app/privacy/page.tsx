...
export const metadata = {
  title: 'Privacy Protocol | Brijvaas Assets',
  description: 'How Brijvaas Assets collects, uses, and safeguards information shared through our brokerage desks and digital channels.',
}
