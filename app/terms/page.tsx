...
export const metadata = {
  title: 'Terms of Placement | Brijvaas Assets',
  description: 'The terms governing engagement with Brijvaas Assets brokerage desks, listing submissions, and acquisition inquiries.',
}

const SECTIONS = [
  {
    title: 'Brokerage Role',
    body: 'Brijvaas Assets acts as a direct placement intermediary between buyers, sellers, and developers. Listings, pricing, and availability are subject to change and should be independently verified before any transaction is finalized.',
  },
  {
