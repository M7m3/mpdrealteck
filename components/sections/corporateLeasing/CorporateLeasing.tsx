  ...
  return (
    <section className="relative bg-slate-50 py-24 lg:py-32" id="corporate-leasing-assets">
      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-6 lg:px-8">
        {/* Leasing Inquiry Reach-Out Desk */}
        <div
          id="leasing-inquiry"
          className="relative scroll-mt-24 overflow-hidden rounded-2xl border border-slate-200/60 bg-white px-6 py-12 shadow-sm sm:px-10 sm:py-16 md:scroll-mt-32"
        >
          {/* Decorative icon watermark */}
          <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
            <svg
              className="absolute -top-10 -right-12 h-40 w-40 rotate-12 text-blue-600/5 sm:h-56 sm:w-56 lg:h-72 lg:w-72"
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth="0.75"
              stroke="currentColor"
            ...
            <svg
              className="absolute -bottom-10 -left-10 h-32 w-32 -rotate-12 text-slate-900/5 sm:h-44 sm:w-44 lg:h-56 lg:w-56"
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth="0.75"
              stroke="currentColor"
            ...
            <svg
              className="absolute top-1/2 left-1/4 hidden h-24 w-24 -translate-y-1/2 rotate-6 text-blue-600/5 sm:block lg:h-32 lg:w-32"
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth="0.75"
              stroke="currentColor"
            ...
            <svg
              className="absolute right-1/4 bottom-6 h-20 w-20 -rotate-6 text-slate-900/5 sm:h-28 sm:w-28"
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth="0.75"
              stroke="currentColor"
          ...
          <div className="relative mx-auto mt-10 max-w-3xl rounded-xl border border-slate-200/60 bg-white p-6 shadow-sm sm:p-8">
            {submitted && (
        ...
        {/* Asset Cards Grid */}
        <div className="mt-20 grid grid-cols-1 gap-8 lg:mt-28 lg:grid-cols-2">
          {properties.map((asset) => (
            <div
              key={asset.id}
