        ...
        <div className="mx-auto w-full max-w-7xl">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-slate-300 lg:text-lg">
              Four decades of direct brokerage experience, now serving clients across India. Corporate leasing, land investment, construction, and interior design, with every asset sourced and verified before it reaches you.
            </p>
